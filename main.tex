...
\titulo{Detec\c{c}\~{a}o de \textit{Haters} nas Redes Sociais}
% \title{Análise de Sentimentos baseada em emoções Aplicada as Redes Sociais}
\title{Detec\c{c}\~{a}o de \textit{Haters} nas Redes Sociais}
...
\include{capitulos/2-referencial}
\include{capitulos/3-desenvolvimento}
\include{capitulos/4-conclusoes}
